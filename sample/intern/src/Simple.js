...
var Simple = function () {
  ...
  */
  ...
  canvas.addEventListener("mousemove", this.mouseEvent, false);

  //var dragMgr = new L2DTargetPoint();
...
Simple.draw = function (gl/*WebGLコンテキスト*/) {
  ...
  live2DModel.setParamFloat("PARAM_BREATH", 0.5 + 0.5 * Math.sin( t/3.2345 ),1);
  live2DModel.setParamFloat("PARAM_MOUTH_FORM", 0.5 + 0.5 * Math.sin( t/3.2345 ));
